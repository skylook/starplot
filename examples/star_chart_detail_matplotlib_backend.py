...
print("🖼️  Generating star chart with MATPLOTLIB backend...")
...
p.export("star_chart_detail_matplotlib.png", transparent=True, padding=0.1)
print("✅ Matplotlib version saved: star_chart_detail_matplotlib.png")