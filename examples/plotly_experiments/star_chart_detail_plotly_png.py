"""
Plotly version of star_chart_detail.py exporting to PNG
"""
...
try:
    ...
    print("✓ Plotly PNG version exported as star_chart_detail_plotly.png")
except Exception as e:
    print(f"✗ PNG export failed: {e}")
    print("Note: PNG export requires kaleido package: pip install kaleido")
    
    # Export as HTML instead
    p.export("star_chart_detail_plotly_backup.html")
    print("✓ Plotly HTML version exported as star_chart_detail_plotly_backup.html")