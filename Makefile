...
lint:
	$(DOCKER_RUN) "ruff check src/ tests/ hash_checks/ tools/visual_parity/ $(ARGS)"

format:
	$(DOCKER_RUN) "python -m black src/ tests/ scripts/ examples/ hash_checks/ tutorial/ data/ tools/visual_parity/ $(ARGS)"
